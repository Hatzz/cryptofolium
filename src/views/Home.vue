<template>
  <div class="flex flex-col">
    ...
    <Holding :openHolding="openHolding" @open="openHolding = $event" v-for="(holding, id) in holdings" :key="id" :id="id" />
    <router-link class="p-4 ml-auto" :to="{ name: 'Search' }">
      <img src="../assets/plus.svg" class="bg-gray-800 p-3 w-11 rounded-full" alt="">
    </router-link>
  </div>
</template>
